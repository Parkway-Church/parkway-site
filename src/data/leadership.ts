...
export const leadershipData: Leader[] = [
    ...
    },
    {
        ...
        name: "Matilde Licea",
        role: "Custodian",
        bio: "I was born and raised in Mexico, where I worked at a local church simply because I enjoyed serving and connecting with the people there. In 1997, I moved to California seeking new opportunities and a fresh start. During that season of transition, God began opening new doors in my life and guiding me toward a new path filled with hope and purpose. Later, I moved to Florida with my husband, where I embraced new opportunities and found a supportive community. Through various jobs and life experiences, I eventually found my way to Parkway Christian Church, where I currently work. Although I was initially hesitant about attending church, my perspective changed when a neighbor invited me to visit. That simple invitation became a turning point in my life and led me into a deeper relationship with God that continues to shape who I am today. I am passionate about growing in my faith and living with the confidence that God has a purpose and plan for my life. Being part of the church has allowed me to grow spiritually and discover the joy of serving others. I am also a proud mother of one daughter and grandmother to two wonderful grandchildren who still live in Mexico. Outside of my work at the church, I dedicate my time to caring for the elderly and supporting those around me with compassion and encouragement.",
